...
//  Inspired by LanguageTool and Grammarly's visual feedback
//
...
class ErrorOverlayWindow: NSWindow {
    ...
    /// Get underline color for severity (LanguageTool style)
...
class UnderlineView: NSView {
    ...
    /// Draw wavy underline (LanguageTool/Grammarly style)
