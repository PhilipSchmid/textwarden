...
/// Designed to match LanguageTool's popup style
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            if let error = popover.currentError {
                ...
                // Suggestions section - prominent like LanguageTool
                ...
                // Action bar - compact like LanguageTool (T124: Keyboard shortcuts)
                HStack(spacing: 12) {
