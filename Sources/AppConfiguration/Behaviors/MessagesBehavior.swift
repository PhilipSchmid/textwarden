//
//  MessagesBehavior.swift
//  TextWarden
//
//  Complete behavior specification for Apple Messages.
//
//  Messages-specific characteristics:
//  - Mac Catalyst app
//  - Plain text input
//  - UTF-16 index handling for emojis
//  - Keyboard-based replacement needed
//

import Foundation

/// Complete behavior specification for Apple Messages
struct MessagesBehavior: AppBehavior {
    let bundleIdentifier = "com.apple.MobileSMS"
    let displayName = "Apple Messages"
