...
class TextMonitor: ObservableObject {
    ...
    private func monitorFocusedElement(in appElement: AXUIElement, retryAttempt: Int = 0) {
        ...
        // This is how ProWritingAid handles Electron apps like Slack
        if !isEditableElement(axElement) {
            ...
            // Strategy 2: Search from main window down (like ProWritingAid)
...
extension TextMonitor {
    /// Search for editable field from main window (like ProWritingAid)
